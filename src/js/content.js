...
//Futureweb
  if (event.target.closest(".tst-new-expense")) {
    ...
    iframe.src = "https://dashboard.fweb.at/pages/article/add/" + project_id;
    ...
    // Function to close the overlay from the HTML page link
    function closeOverlayFromLink() {
      closeOverlay();
      window.parent.postMessage('closeOverlay', '*');
    }

    // Listen for the 'closeOverlay' message from the HTML page
