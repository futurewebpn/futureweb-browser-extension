...
- merged Upstream 2.4.0
- Fixed Bug with Bubble/Timeentries Jira
...
- Version last digit = used Moco Fork, only update if upstream is merged
- Adding available hours within Bubble/Timeentries
- Removed Ticket Title from Jira, as we want employees to enter what they have done
